...
# E-Mails and Links
GMAIL_ADDRESS = "apoboat@gmail.com"
SERVICE_EMAIL = "apoboat@gmail.com"         # Mailbox to check for new request messages 
...
# This supports  most of the same advanced search syntax as the Gmail web interface
# ALLOWED_EMAIL_QUERY = ["@message.inmarsat.com"]     # Only allow messages from Inmarsat phones to be processed
ALLOWED_EMAIL_QUERY = ["jaco.r.colo@gmail.com"]     # Only allow messages from Inmarsat phones to be processed
# ALLOWED_REPLY_EMAIL = r'@message\.inmarsat\.com$'
ALLOWED_REPLY_EMAIL_REGEXP = r'jaco\.r\.colo@gmail\.com'
